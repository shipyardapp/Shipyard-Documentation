...
title: Microsoft Excel Template - Upload Data to Workbook from Platform
hide_title: true
sidebar_label: Upload Data to Workbook from Platform
description: Information about Platform's low-code Microsoft Excel Upload Data to Workbook from Platform blueprint. Quickly upload data to an Excel workbook
keywords:
  - microsoft excel
  - blueprint
  - template
...
# Microsoft 365 Excel - Upload Data to Workbook from Platform



## Overview

This blueprint is used to upload data from Platform to a new or exisitng file. Once the data is loaded to the Excel workbook, it will reside in a single sheet called `Sheet1`. 
