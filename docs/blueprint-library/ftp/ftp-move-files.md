---
id: ftp-move-files
title: FTP Template - Move Files
hide_title: true
sidebar_label: Move Files
description: Information about Shipyard's low-code FTP Move Files blueprint. Quickly move one or more files from an FTP Server. Once the files have moved, transfer them to another service or run another Vessel against the data.
keywords:
    - ftp
    - blueprint
    - template
