...
|:---|:---|:---|:---|:---|:---|:---|
| Compression Type | compression | Select | :white_check_mark: | `zip` | .zip: `zip`<br></br><br></br>.tar: `tar`<br></br><br></br>.tar.bz2: `tar.bz2`<br></br><br></br>.tar.gz: `tar.gz` | Type of compression to use on the provided files. |
