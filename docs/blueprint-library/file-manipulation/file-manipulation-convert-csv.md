...
|:---|:---|:---|:---|:---|:---|:---|
| Destination File Format | destination_file_format | Select | :white_check_mark: | `tsv` | `TSV (Tab-Separated File): `tsv``, `PSV (Pipe-Separated File): `psv``, `XLSX (Excel File): `xlsx``, `Parquet: `parquet``, `Stata: `stata``, `hdf5` | Type of file that you want the CSV file(s) converted into. |
